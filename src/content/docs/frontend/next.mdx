...
<Tabs>
  <TabItem label="about/[id]">

```tsx filename="about/[id]"
"use client";
...
```
  ...
  <TabItem label="about/[...idList]">

```tsx filename="about/[...idList]"
"use client";
...
```
  ...
  <TabItem label="about-id/[[...optionalList]]">

```tsx filename="about-id/[[...optionalList]]"
"use client";
...
<Tabs>
  <TabItem label="api/chat/route.ts">
...
```
  ...
  <TabItem label="my-component.tsx">
...
<Tabs>
  <TabItem label="lib/login/actions.ts">
...
```
  ...
  <TabItem label="app/[lang]/home/switch-i18n.tsx">

```tsx filename="app/[lang]/home/switch-i18n.tsx"
"use client";
...
```
  ...
  <TabItem label="app/[lang]/home/page.tsx">
```tsx filename="app/[lang]/home/page.tsx"
...
```
  ...
  <TabItem label="next/constants 内置常量">
