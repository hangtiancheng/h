...
<Tabs>
  <TabItem label="vitest.config.ts">
...
```
  ...
  <TabItem label="tests/App.test.tsx">
...
<Tabs>
  <TabItem label="src/components/toggle-purple.tsx">
...
```
  ...
  <TabItem label="tests/components/toggle-purple.test.tsx">
...
```
  ...
  <TabItem label="tests/setup-jsdom.ts">
...
```
  ...
  <TabItem label="tsconfig[.app].json">
...
<Tabs>
  <TabItem label="@/components/button.tsx">
...
```
  ...
  <TabItem label="@/components/button.css">
...
```
  ...
  <TabItem label="tests/components/button.test.tsx">
...
<Tabs>
  <TabItem label="src/components/note-item.tsx">
...
```
  ...
  <TabItem label="tests/components/note-item.test.tsx">
...
```
  ...
  <TabItem label="替换 jotai 中的 useAtomValue">
...
<Tabs>
  <TabItem label="tests/vitest.setup.ts">
