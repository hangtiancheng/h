...
```
  ...
  <TabItem label="@/views/LoginView.vue">
...
```
  ...
  <TabItem label="@/views/RegisterView.vue">
...
```
  ...
  <TabItem label="@/views/HomeView.vue">

```vue filename="@/views/HomeView.vue"
<template>
  <div>
    <!-- 必须加上 /home 前缀 -->
...
<Tabs>
  <TabItem label="@/components/ProgressBar.vue">
