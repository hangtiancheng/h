...
<Tabs>
<Tab label="src/components/toggle-purple.tsx">
...
<Tab label="tests/components/toggle-purple.test.tsx">
...
<Tab label="tests/setup-jsdom.ts">
...
<Tab label="json [tsconfig[.app].json]">
...
<Tab label="@/components/button.css">
...
<Tab label="tests/components/button.test.tsx">
...
<Tabs>
<Tab label="src/components/note-item.tsx">
...
<Tab label="tests/components/note-item.test.tsx">
...
<Tab label="替换 jotai 中的 useAtomValue">
...
<Tabs>
<Tab label="tests/vitest.setup.ts">
