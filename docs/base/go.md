...
推广: 全站推广 (搜索+推荐)、关键词推广 (搜索)、人群推广 (拉新, 目标人群渗透)、内容营销 (直播、短视频)

报表

洞察: 行业解析 (预算)、竞争解析、流量解析 (搜索关键词)、趋势、人群洞察、场景洞察 (达人种草)

创意: AI 素材、AI 洞察、AI 视频、AI 生图、AI 数字人 (种草讲解官)、AI 文案
...
- 对于 ROI 表现优异计划，预算即将花完时自动追加预算
- 对于重点计划，保障夜间黄金时段不停投，生意不断
