...
<Tabs items={['Will not print', 'Will print']}>
<Tab value="Will not print">
...
<Tabs items={['channel', 'mutex', '原子操作', '信号量 channel', '信号量 semaphore']}>
<Tab value="channel">
...
<Tabs items={['context.WithCancel', 'context.WithDeadline, context.WithTimeout']}>
<Tab value="context.WithCancel">
...
<Tab value="context.WithDeadline, context.WithTimeout">
...
<Tabs items={['Go runtime', 'JS V8', 'Go pprof', 'Go trace', 'go tool', 'pprof commands']}>
<Tab value="Go runtime">
