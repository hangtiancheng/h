...
1. 项目级: ${workDir}/.yukino/skills/
2. 用户级: ~/.yukino/skills
3. 内置级: Yukino 内置的 skills
...
Yukino 启动时, 扫描 skills 目录, 加载所有 skill 的 frontmatter 元信息 (name, description), 不加载完整 prompt 正文, 将 skill 元信息注入到 system prompt, 告诉 LLM 有哪些 skill
