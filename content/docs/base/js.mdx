...
echo 'module.exports = { name: "yukino" }; console.log(arguments);' > ./cjs-module.js && node ./cjs-module.js
```

```js
(function (exports, require, module, __filename, __dirname) {
  module.exports = { name: "yukino" };
...
```js
const obj1 = { name: "yukino", age: 2 };
const obj2 = { name: "yukino", age: 2, gender: "male" };
...
const user: InferredGenericsType = { name: "yukino", age: 1 };
...
const user2: RecursivelyInferredGenericsType = { name: "yukino", age: 1 };
```

### infer 协变 (类型的并集), 逆变 (类型的交集)

```ts
const user = { name: "yukino", age: 1 };
