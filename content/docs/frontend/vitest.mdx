...
<Callout type="warn" title="Pitfall 陷阱">
...
<Tab value="src/components/toggle-purple.tsx">
...
<Tab value="tests/components/toggle-purple.test.tsx">
...
<Tabs items={['vitest.config.ts', 'tests/setup-jsdom.ts', 'json [tsconfig[.app].json]']}>
<Tab value="vitest.config.ts">
...
<Tab value="tests/setup-jsdom.ts">
...
<Tab value="json [tsconfig[.app].json]">
...
<Tabs items={['错误示例', 'tests/components/toggle-purple.test.tsx']}>
<Tab value="错误示例">
...
<Tab value="@/components/button.tsx">
...
<Tab value="@/components/button.css">
...
<Tab value="tests/components/button.test.tsx">
...
<Tab value="src/components/note-item.tsx">
...
<Tab value="tests/components/note-item.test.tsx">
...
<Tab value="替换 jotai 中的 useAtomValue">
...
<Tab value="tests/vitest.setup.ts">
