...
<Tabs items={['layout.tsx', 'template.tsx', '{yukino,yukino2}/page.tsx', 'loading.tsx', 'error.tsx']}>
  ...
  render() {
    ...
    return (
      <>
        ...
        <Link href="/about/yukino">/about/yukino</Link>
        <Link href="/about/yukino2">/about/yukino2</Link>
...
<Tab value="{yukino,yukino2}/page.tsx">
...
// about/yukino/page.tsx
export default function AboutYukinoPage() {
  return <>About Yukino</>;
}

// about/yukino2/page.tsx
export default function AboutYukino2Page() {
  return <>About Yukino2</>;
}
```
...
```tsx
<Link href={{ pathname: "/about/yukino", query: { name: "yukino", age: 24 } }}>
  /about/yukino?name=yukino&age=24
</Link>
...
export default function YukinoPage() {
  ...
  return (
    <>
      ...
      <button onClick={() => router.refresh()}>refresh /about/yukino</button>
      <button onClick={() => router.prefetch("/about/yukino2")}>
        prefetch /about/yukino2
      </button>
    </>
  );
}
...
<Tabs items={['tsx [about/[id]]', 'tsx [about/[...idList]]', 'tsx [about-id/[[...optionalList]]]']}>
<Tab value="tsx [about/[id]]">
...
<Tab value="tsx [about-id/[[...optionalList]]]">
  ...
  matcher: [
    ...
    },
    {
      ...
      has: [
        ...
        // 必须携带 query 查询参数, 键为 username, 值为 yukino
        { type: "query", key: "username", value: "yukino" },
      ],
...
<Tab value="lib/login/actions.ts">
...
```shell
pnpm add negotiator @formatjs/intl-locale
...
<Tabs items={['proxy.ts', 'tsx [app/[lang]/home/switch-i18n.tsx]', 'tsx [app/[lang]/home/page.tsx]']}>
<Tab value="proxy.ts">
...
import { match } from "@formatjs/intl-locale";
...
<Tab value="tsx [app/[lang]/home/switch-i18n.tsx]">
...
<Tab value="tsx [app/[lang]/home/page.tsx]">
