...
<img src="public/favicon.svg" alt="Swifty Homepage" width="96" />
...
The `chucks/` directory additionally holds an **algorithm notebook** — curated
...
└── chucks/                      # algorithm notebook (Go / JS / TS)
```
